    ...
    switch((int)$_GET['cmd']) {
        ...
        case 4:
            ...
            $menu_arr = array(
                ...
                array(
                        'url' => 'index.php?cmd=2', 'text' => $LANG_PUBCONTROL_UPLUGIN[23]
                    ),
                array(
                        'url' => 'index.php?cmd=4', 'text' => $LANG_PUBCONTROL_UPLUGIN[22]
                    )
                );
        ...
        case 5:
            ...
            if((count($accesscodes) === 0) || (count($groups) === 0)) {
                header("Location: index.php?msg=44");
                exit;
            }
...
#                array('text' => $LANG_PUBCONTROL_UPLUGIN[21], 'field' => 'group_id', 'sort' => true),
            ...
            $menu_arr = array(
                ...
                array(
                        'url' => 'index.php?cmd=5', 'text' => $LANG_PUBCONTROL_UPLUGIN[32]
                    ),
                array(
                        'url' => 'index.php?cmd=7', 'text' => $LANG_PUBCONTROL_UPLUGIN[36]
                    )
                );
            ...
            $text_arr = array(
                'has_extras'   => true,
                'instructions' => 'I can haz instructions!!',
                'form_url'     => ($id === 0) ? 'index.php?cmd=7' : 'index.php?cmd=7&gid='.$id
            );
        ...
        case 10:
            ...
            $menu_arr = array(
                ...
                array(
                        'url' => 'index.php?cmd=9', 'text' => $LANG_PUBCONTROL_UPLUGIN[46]
                    ),
                array(
                        'url' => 'index.php?cmd=10', 'text' => $LANG_PUBCONTROL_UPLUGIN[49]
                    )
                );
...
##            }
        ...
        case 12:
            ...
            $text_arr = array(
                'has_extras'   => true,
                'instructions' => 'I can haz instructions!!',
                'form_url'     => 'index.php?cmd=12&id='.$id
            );
...
else if(isset($_GET['ret']))
{
    ...
    switch($_GET['ret']) {
        ...
        case "group_delete":
            ...
            // Invalid identifier
            if($id === 0) {
                header("Location: index.php?cmd=4&msg=15");
                exit;
            }
            ...
            try {
                ...
                header("Location: index.php?cmd=4&msg=41");
                exit;
            }
        ...
        case "feed_modify":
            ...
            header("Location: index.php?cmd=7&msg=4");
        ...
        case "feed_delete":
            ...
            // Invalid identifier
            if($id === 0) {
                header("Location: index.php?cmd=7&msg=15");
                exit;
            }
            ...
            try {
                ...
                header("Location: index.php?cmd=7&msg=42");
                exit;
            }
        ...
        case "sgroup_delete":
            ...
            try {
                ...
                header("Location: index.php?cmd=10&msg=48");
                exit;
            }
        ...
        case "sgroupfeed_delete":
            ...
            header("Location: index.php?cmd=12&id=$id&msg=4");
            break;
        case "sgroup_addfeed":
